    ...
    def _execution(self):
        while not EXIT.get_status():
            ...
            try:
                ...
                # This exception happens because the socket timeout after TIMEOUT_SOCKET seconds (in script header)
                # Without this timeout, the program will be stuck on accept until a connection happens
